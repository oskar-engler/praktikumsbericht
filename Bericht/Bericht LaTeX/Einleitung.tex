...
\large {Die Firma Belectric GmbH wurde im 2001 gegründet und hat seinen Standort im Kolitzheim. Seit dem wurden über 1,5 GWp Solarleistung weltweit installiert. Die Belectric GmbH wurde damit zu einem Weltmarktführer in dem Bereich der Installation von Freiflächensolarkraftwerken. Es werden neue und innovative Technologien bei der Installation umgesetzt. Weltweit hat die Belectric über 1600 Beschäftigte, die in den Bereichen von Wartung und Anlagenbau bis hin zu Forschung und Entwicklung tätig sind. \\
